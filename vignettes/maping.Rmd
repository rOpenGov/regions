---
title: "Maping Regional Data, Maping Metadata Problems"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Maping Regional Data, Maping Metadata Problems}
...
```{r rd-workforce-max-5, include=FALSE}
n_try <- 0

while ( n_try < 5) {
  n_try <- n_try+1
  
  rd_workforce <- purrr::safely(
    eurostat::get_eurostat_json, NULL)(
                id = "rd_p_persreg", 
                filters = list (
                      sex = "T",     
                      prof_pos = "TOTAL",
...
if ( is.null(rd_workforce$error) ) {
  n_try <- 5
  rd_workforce <- rd_workforce$result 
  } else {
  Sys.sleep(1)
  }
}
